...
def visualize_product_data(products):
    if products:
        ...
        #product_names = [product['Product'][:25] + '...' if len(product['Product']) > 25
                                            else product['Product'] for product in products]
...
### Output:
<img src = "https://github.com/user-attachments/assets/7561e6a5-2751-487c-bf50-09922894d221" width=50%>

<img src = "https://github.com/user-attachments/assets/d82c29e1-5b81-49d1-aaab-7e17d58dfa34" width=50% >

<img src = "https://github.com/user-attachments/assets/92a5f692-b46f-4622-a919-e36a0040c735" width=50% >
